...
(define (install-polynomial-package)
  ...
  (define (pseudoremainder-terms L1 L2)
    (remainder-terms (scale-terms (pow (coeff (first-term L2))
...
(display "q1: ") (print q1) (newline)
(display "q2: ") (print q2) (newline)

(define d (greatest-common-divisor q1 q2))

(display "gcd: ") (print d) (newline)
