...
(eval '(define (y) (20)) the-global-environment)
(eval '(define z (let ((x 50) (y 8)) (- x y))) the-global-environment)

(user-print (eval 'x the-global-environment)) (newline)
(user-print (eval 'y the-global-environment)) (newline)
(user-print (eval 'z the-global-environment)) (newline)
