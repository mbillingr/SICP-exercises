...
(define inv-cos-series (invert-unit-series cosine-series))
(println (stream-ref inv-cos-series 0))  ; 1
(println (stream-ref inv-cos-series 1))  ; 0
(println (stream-ref inv-cos-series 2))  ; 0.5
(println (stream-ref inv-cos-series 3))  ; 0
(println (stream-ref inv-cos-series 4))  ; 0.208333
