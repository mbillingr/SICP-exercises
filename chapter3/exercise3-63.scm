...
; This implementation of sqrt-stream effectively circumvents memoization
; because it defines the cdr recursively as a *new* stream. To access the next
; element it has to recompute the entire preceding stream.
;
; The correct implementation (further above) uses a local variable to define
; the cdr recursively on the *same* stream, which is being memoized.
